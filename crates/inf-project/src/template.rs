...
impl ProjectTemplate {
    ...
    /// dir, if this template ships one. Today only the Hybrid 2.5D template does
    /// (the 2.5D showcase — a 3D plane + billboarded sprites + a 2D light,
    /// generated by `inf_editor_core::samples::hybrid_scene`).
