...
pub const MW_WEAPON_ART: &[MwWeaponArt] = &[
    (
        "SM_MW_LAUNCHER_01",
        [0.0, 0.0933, 0.1953],
        [-0.0714, -0.0467, -0.7634],
        [0.0714, 0.1675, 0.6201],
        None,
    ),
    (
        "SM_MW_PISTOL_01",
        [0.0, 0.0713, 0.1652],
        [-0.0114, -0.0561, -0.0491],
        [0.0116, 0.0863, 0.1625],
        Some([0.0, -0.0244, -0.0142]),
    ),
    (
        "SM_MW_PISTOL_02",
        [0.0, 0.0791, 0.1740],
        [-0.0123, -0.0436, -0.0433],
        [0.0123, 0.0923, 0.1717],
        Some([0.0, -0.0244, -0.0142]),
    ),
    (
        "SM_MW_PISTOL_03",
        [0.0, 0.0695, 0.1393],
        [-0.0145, -0.0396, -0.0402],
        [0.0145, 0.0827, 0.1382],
        Some([0.0, -0.0244, -0.0142]),
    ),
    (
        "SM_MW_PISTOL_04",
        [0.0, 0.0797, 0.1907],
        [-0.0169, -0.0524, -0.0547],
        [0.0169, 0.0962, 0.1888],
        Some([0.0, -0.0244, -0.0142]),
    ),
    (
        "SM_MW_REVOLVER_01",
        [0.0, 0.0974, 0.2811],
        [-0.0225, -0.0331, -0.0545],
        [0.0225, 0.1197, 0.2800],
        None,
    ),
    (
        "SM_MW_REVOLVER_02",
        [0.0, 0.0971, 0.2037],
        [-0.0225, -0.0331, -0.0545],
        [0.0225, 0.1197, 0.2024],
        None,
    ),
    (
        "SM_MW_SHOTGUN_01",
        [0.0, 0.0699, 0.7551],
        [-0.0241, -0.0889, -0.2181],
        [0.0241, 0.0955, 0.7535],
        None,
    ),
    (
        "SM_MW_SHOTGUN_02",
        [0.0, 0.0945, 0.6855],
        [-0.0349, -0.0442, -0.2439],
        [0.0349, 0.1222, 0.6835],
        None,
    ),
    (
        "SM_MW_SHOTGUN_03",
        [0.0, 0.0832, 0.6724],
        [-0.0184, -0.0938, -0.2206],
        [0.0184, 0.0956, 0.6704],
        None,
    ),
    (
        "SM_MW_SHOTGUN_04",
        [0.0, 0.0916, 0.4533],
        [-0.0882, -0.0855, -0.2210],
        [0.0882, 0.1735, 0.4513],
        Some([0.0, -0.0015, 0.1261]),
    ),
];
