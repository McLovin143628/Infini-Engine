...
fn hold(deg: f32) -> AnimClip {
    ...
    // Through the constructor since `.inf_anim` v2 (P29.2); `duration` is set
    // afterwards because one key at t=0 derives a zero-length clip and this
    // fixture wants a 1 s state period.
