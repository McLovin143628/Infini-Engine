...
/// The minimal **blank 3D** starter scene: a ground plane, a directional sun and
/// a camera looking at the origin. Scaffolded by `inf new --template blank-3d`
/// (the default template).
///
/// Deliberately three entities. It is a starting point rather than a demo, and
/// the one property it must have is the one IB-7 was about: `inf new` →
/// `inf cook` → `inf-player --pack` runs it.
