...
use inf_editor_core::ipc::{
    ...
    PackageResultDto, PartitionSettingsDto, PcgStreamStatusDto, PhotoEntryDto, ProjectBootDto,
    ...
    SceneDelta, SceneNode, SceneSnapshot, ScriptDiagnosticDto, SculptFalloffDto, SculptOpDto,
...
fn export_bindings() {
    ...
    PcgStreamStatusDto::export_all(&cfg).expect("export PcgStreamStatusDto");
